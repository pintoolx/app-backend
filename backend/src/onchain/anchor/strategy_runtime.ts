...
export type StrategyRuntime = {
  ...
  instructions: [
    {
      ...
      docs: ['Phase 1 — close a stopped deployment, returning rent to the creator.'];
      discriminator: [0, 65, 162, 218, 47, 208, 26, 62];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    },
    {
      ...
      docs: ['Phase 2 — close a closed follower vault, returning rent to the follower.'];
      discriminator: [110, 107, 247, 154, 8, 245, 123, 179];
      accounts: [
        {
          name: 'follower';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [150, 156, 154, 247, 250, 176, 124, 166];
      accounts: [
        {
          name: 'creator';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [112, 117, 98, 108, 105, 99, 95, 115, 110, 97, 112, 115, 104, 111, 116];
              },
              {
                kind: 'account';
                path: 'deployment';
    ...
    },
    {
      ...
      discriminator: [164, 99, 111, 180, 51, 128, 67, 75];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [201, 80, 148, 145, 9, 196, 225, 56];
      accounts: [
        {
          name: 'creator';
          signer: true;
    ...
    },
    {
      ...
      discriminator: [44, 223, 147, 117, 8, 190, 255, 88];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [26, 244, 148, 247, 58, 170, 109, 182];
      accounts: [
        {
          name: 'creator';
          writable: true;
        ...
        {
          name: 'delegationRecordStrategyState';
          writable: true;
          pda: {
            seeds: [
              {
        ...
        {
          name: 'delegationMetadataStrategyState';
          writable: true;
          pda: {
            seeds: [
              {
    ...
    },
    {
      ...
      discriminator: [170, 47, 77, 172, 226, 183, 47, 224];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [129, 224, 47, 216, 30, 160, 254, 248];
      accounts: [
        {
          name: 'follower';
          writable: true;
    ...
    },
    {
      ...
      docs: ['Phase 2 — create the follower vault PDA bound to a subscription.'];
      discriminator: [116, 211, 222, 132, 131, 66, 103, 133];
      accounts: [
        {
          name: 'follower';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [102, 111, 108, 108, 111, 119, 101, 114, 95, 118, 97, 117, 108, 116];
              },
              {
                kind: 'account';
                path: 'subscription';
    ...
    },
    {
      ...
      discriminator: [62, 32, 180, 193, 34, 199, 156, 144];
      accounts: [
        {
          name: 'follower';
          writable: true;
    ...
    },
    {
      ...
      docs: ['Phase 1 — initialise the private state pointer with revision = 0.'];
      discriminator: [17, 112, 180, 5, 104, 112, 237, 204];
      accounts: [
        {
          name: 'creator';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [115, 116, 114, 97, 116, 101, 103, 121, 95, 115, 116, 97, 116, 101];
              },
              {
                kind: 'account';
                path: 'deployment';
    ...
    },
    {
      ...
      docs: ['Phase 1 — register an immutable strategy version with hashes.'];
      discriminator: [90, 125, 163, 166, 179, 178, 143, 70];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    },
    {
      ...
      docs: ['Phase 1 — register a vault authority PDA owned by the deployment.'];
      discriminator: [47, 125, 11, 209, 248, 240, 52, 77];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    },
    {
      ...
      docs: ['Phase 2 — lifecycle transition for follower vault and its subscription.'];
      discriminator: [132, 242, 199, 183, 43, 164, 165, 13];
      accounts: [
        {
          name: 'follower';
          writable: true;
    ...
    },
    {
      ...
      docs: ['Phase 1 — apply a lifecycle transition (state machine enforced).'];
      discriminator: [213, 110, 41, 59, 63, 128, 0, 162];
      accounts: [
        {
          name: 'creator';
          signer: true;
    ...
    },
    {
      ...
      docs: ['Phase 1 — publish/update the public snapshot (monotonic revision).'];
      discriminator: [150, 34, 45, 243, 165, 224, 1, 232];
      accounts: [
        {
          name: 'creator';
          writable: true;
  ...
  accounts: [
    {
      name: 'followerVault';
      discriminator: [110, 28, 220, 217, 243, 116, 178, 127];
    },
    {
      name: 'followerVaultAuthority';
      discriminator: [10, 191, 26, 44, 189, 30, 81, 71];
    },
    {
      name: 'publicSnapshot';
      discriminator: [181, 191, 251, 130, 141, 12, 185, 59];
    },
    {
      name: 'strategyDeployment';
      discriminator: [254, 129, 110, 2, 29, 29, 89, 139];
    },
    {
      name: 'strategyState';
      discriminator: [83, 18, 224, 109, 174, 100, 39, 139];
    },
    {
      name: 'strategySubscription';
      discriminator: [3, 219, 166, 34, 148, 79, 177, 227];
    },
    {
      name: 'strategyVersion';
      discriminator: [96, 218, 183, 254, 179, 87, 232, 175];
    },
    {
      name: 'vaultAuthority';
      discriminator: [132, 34, 187, 202, 202, 195, 211, 53];
    },
  ];
  errors: [
    {
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'vaultId';
            docs: ['16-byte UUID mirroring the off-chain `follower_vaults.id`.'];
            type: {
              array: ['u8', 16];
            };
          },
          {
            ...
            docs: ['0 = pending_funding, 1 = active, 2 = paused, 3 = exiting, 4 = closed'];
            type: 'u8';
          },
          {
            name: 'custodyMode';
            docs: ['0 = program_owned, 1 = self_custody, 2 = private_payments_relay'];
            type: 'u8';
          },
          {
            name: 'createdSlot';
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'status';
            docs: ['0 = active, 1 = frozen'];
            type: 'u8';
          },
          {
            name: 'allowedMintConfigHash';
            docs: ['Hash over the allowed mint config — empty until configured.'];
            type: {
              array: ['u8', 32];
            };
          },
    ...
    {
      name: 'publicSnapshot';
      docs: ['Public snapshot — sanitised view of the deployment for marketplace/leaderboard.'];
      type: {
        kind: 'struct';
        fields: [
          {
          ...
          {
            name: 'riskBand';
            docs: ['Risk band code: 0=unknown,1=low,2=medium,3=high'];
            type: 'u8';
          },
          {
            name: 'pnlSummaryBps';
            docs: ['PnL summary in bps (signed, can be negative).'];
            type: 'i32';
          },
          {
            name: 'publicMetricsHash';
            docs: ['Hash over the larger off-chain metrics blob.'];
            type: {
              array: ['u8', 32];
            };
          },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: 'creator';
            docs: ['Wallet that authored the strategy.'];
            type: 'pubkey';
          },
          {
            name: 'strategyId';
            docs: ['16-byte UUID identifying the parent strategy in the off-chain DB.'];
            type: {
              array: ['u8', 16];
            };
          },
          {
            name: 'version';
            docs: ['Monotonic version number assigned at publish time.'];
            type: 'u32';
          },
          {
            name: 'publicMetadataHash';
            docs: ['Hash over the sanitised public metadata (display surface).'];
            type: {
              array: ['u8', 32];
            };
          },
          {
            name: 'privateDefinitionCommitment';
            docs: ['Commitment over the private definition (full IR).'];
            type: {
              array: ['u8', 32];
            };
          },
          {
            name: 'registeredSlot';
            docs: ['Slot the version was registered on chain.'];
            type: 'u64';
          },
          {
            name: 'bump';
          ...
          {
            name: 'reserved';
            docs: ['Reserved bytes for forward compatibility.'];
            type: {
              array: ['u8', 64];
            };
          },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'custodyMode';
            docs: ['0=public_self_custody, 1=program_owned, 2=private_payments_relay'];
            type: 'u8';
          },
          {
            name: 'status';
